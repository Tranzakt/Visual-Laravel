...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mariadb' => [
            'driver' => 'mariadb',
            'url' => env('DB_MARIADB_URL'),
            'host' => env('DB_MARIADB_HOST', '127.0.0.1'),
            'port' => env('DB_MARIADB_PORT', '3306'),
            'database' => env('DB_MARIADB_DATABASE', 'laravel'),
            'username' => env('DB_MARIADB_USERNAME', 'root'),
            'password' => env('DB_MARIADB_PASSWORD', ''),
            'unix_socket' => env('DB_MARIADB_SOCKET', ''),
            'charset' => env('DB_MARIADB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_MARIADB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => env('DB_MARIADB_PREFIX', ''),
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
